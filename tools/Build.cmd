...
call dotnet build %WebSdkRoot%\src\ProjectSystem\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.csproj /p:SkipInvalidConfigurations=true;configuration=Release
if errorlevel 1 GOTO ERROR
...
xcopy %WebSdkbin%\Release\net46\win7-x86\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.dll %DOTNET_INSTALL_DIR%\Sdk\%DOTNET_VERSION%\Sdks\Microsoft.NET.Sdk.Web.Publish\tools\net46\ /y /C
xcopy %WebSdkbin%\Release\netstandard1.3\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.dll %DOTNET_INSTALL_DIR%\Sdk\%DOTNET_VERSION%\Sdks\Microsoft.NET.Sdk.Web.ProjectSystem\tools\netcoreapp1.0\ /y /C
...
call dotnet msbuild %WebSdkRoot%\test\ProjectSystem\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests.csproj /p:SkipInvalidConfigurations=true;configuration=Release;TargetFramework=net46 /t:Restore
if errorlevel 1 GOTO ERROR
...
call dotnet test %WebSdkRoot%\test\ProjectSystem\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests.csproj /p:SkipInvalidConfigurations=true;configuration=Release;TargetFramework=net46
if errorlevel 1 GOTO ERROR

call dotnet test %WebSdkRoot%\test\ProjectSystem\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests\Microsoft.NET.Sdk.Web.ProjectSystem.Tasks.Tests.csproj /p:SkipInvalidConfigurations=true;configuration=Release;TargetFramework=netcoreapp1.0
if errorlevel 1 GOTO ERROR
